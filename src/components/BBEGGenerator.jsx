...
const BBEGGenerator = () => {
  ...
  return (
    <div className="bbeg-generator">
      <h2>BBEG Generator</h2>
      <button onClick={generateBBEG} className="generate-btn">
        Generate BBEG
      </button>

      {bbeg && (
        <div className="bbeg-card">
          <p>
            <strong>Name:</strong> {bbeg.name}
          </p>
          <p>
            <strong>Title:</strong> {bbeg.title}
          </p>
          <p>
            <strong>Description:</strong> {bbeg.description}
          </p>
          <p>
            <strong>Archetype:</strong> {bbeg.archetype}
          </p>
          <p>
            <strong>Goal:</strong> {bbeg.goal}
          </p>
          <p>
            <strong>Backstory:</strong> {bbeg.backstory}
          </p>
          <p>
            <strong>Quirk:</strong> {bbeg.quirk}
          </p>
          <p>
            <strong>Weakness:</strong> {bbeg.weakness}
          </p>
          <p>
            <strong>Plan:</strong> {bbeg.plan}
          </p>
          <p>
            <strong>Secret:</strong> {bbeg.secret}
          </p>
        </div>
      )}
    </div>
